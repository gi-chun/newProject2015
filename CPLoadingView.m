...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        UIImage *iconImage1 = [UIImage imageNamed:@"loding_cha_01.png"];
        UIImage *iconImage2 = [UIImage imageNamed:@"loding_cha_02.png"];
        UIImage *iconImage3 = [UIImage imageNamed:@"loding_cha_01.png"];
        UIImage *iconImage4 = [UIImage imageNamed:@"loding_cha_02.png"];
        UIImage *iconImage5 = [UIImage imageNamed:@"loding_cha_01.png"];
        UIImage *iconImage6 = [UIImage imageNamed:@"loding_cha_02.png"];
